...
---
Objective : 'Refine the requirement or issue with Acceptance Criteria, Technical Considerations, Edge Cases, and NFRs'

---

# Refine Requirement or Issue Chat Mode

When activated, this mode allows the agent to analyze an existing issue and enrich it with structured details including:
...
The agent will modify the issue description and add structured details to it. 
