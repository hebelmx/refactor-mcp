...
RefactorMCP is a Model Context Protocol server that provides C# refactoring capabilities through Roslyn. The architecture follows these key patterns:
