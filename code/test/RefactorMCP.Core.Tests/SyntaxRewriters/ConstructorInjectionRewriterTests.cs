...
namespace RefactorMCP.Core.Tests.SyntaxRewriters;
...
public class TestClass
{
    public void TestMethod(string param1, int param2, bool param3) 
    {
        ...
        methodDecl.ParameterList.Parameters.Should().HaveCount(2);
        methodDecl.ParameterList.Parameters.Should().NotContain(p => p.Identifier.Text == "param2");
        methodDecl.ParameterList.Parameters.Should().Contain(p => p.Identifier.Text == "param1");
        methodDecl.ParameterList.Parameters.Should().Contain(p => p.Identifier.Text == "param3");
    }
...
public class TestClass
{
    ...
    public void OtherMethod(string param1, int param2) 
    {
        ...
        otherMethod.ParameterList.Parameters.Should().HaveCount(2);
        otherMethod.ParameterList.Parameters.Should().Contain(p => p.Identifier.Text == "param2");
    }
...
public class TestClass
{
    public void TestMethod(string param1, int param2) 
    {
        ...
        identifierNames.Should().Contain(i => i.Identifier.Text == "_param2");
        identifierNames.Should().NotContain(i => i.Identifier.Text == "param2");
    }
...
public class TestClass
{
    public void TestMethod(string param1, int param2) 
    {
        ...
        // Assert
        var identifierNames = result.DescendantNodes().OfType<IdentifierNameSyntax>().ToList();
        identifierNames.Should().Contain(i => i.Identifier.Text == "param1");
        identifierNames.Should().Contain(i => i.Identifier.Text == "_param2");
    }
...
public class TestClass
{
    ...
    public void CallTestMethod()
    {
        ...
        invocation.ArgumentList.Arguments.Should().HaveCount(2);
        invocation.ArgumentList.Arguments.Should().NotContain(a => a.ToString().Contains("42"));
    }
...
public class TestClass
{
    ...
    public void TestMethod(string param1, int param2) 
    {
        ...
        constructor.ParameterList.Parameters.Should().HaveCount(1);
        constructor.ParameterList.Parameters.Should().Contain(p => p.Identifier.Text == "param2");
        
        var classDecl = result.DescendantNodes().OfType<ClassDeclarationSyntax>().First();
        classDecl.Members.OfType<FieldDeclarationSyntax>().Should().HaveCount(1);
        classDecl.Members.OfType<FieldDeclarationSyntax>().First()
            .Declaration.Variables.Should().Contain(v => v.Identifier.Text == "_param2");
    }
...
public class TestClass
{
    ...
    public void TestMethod(string param1, int param2) 
    {
        ...
        // Assert
        var classDecl = result.DescendantNodes().OfType<ClassDeclarationSyntax>().First();
        classDecl.Members.OfType<PropertyDeclarationSyntax>().Should().HaveCount(1);
        classDecl.Members.OfType<PropertyDeclarationSyntax>().First()
            .Identifier.Text.Should().Be("_param2");
        classDecl.Members.OfType<FieldDeclarationSyntax>().Should().BeEmpty();
    }
...
public class TestClass
{
    ...
    public void TestMethod(string param1, int param2) 
    {
        ...
        classDecl.Members.OfType<FieldDeclarationSyntax>().First()
            .Declaration.Variables.Should().Contain(v => v.Identifier.Text == "_param2");
        classDecl.Members.OfType<PropertyDeclarationSyntax>().Should().BeEmpty();
    }
...
public class TestClass
{
    ...
    public void TestMethod(string param1, int param2) 
    {
        ...
        // Assert
        var constructor = result.DescendantNodes().OfType<ConstructorDeclarationSyntax>().First();
        constructor.Body!.Statements.Should().HaveCount(1);
        constructor.Body.Statements.First().Should().BeOfType<ExpressionStatementSyntax>();
        
        var assignment = constructor.Body.Statements.First() as ExpressionStatementSyntax;
        assignment!.Expression.Should().BeOfType<AssignmentExpressionSyntax>();
        
        var assignmentExpr = assignment.Expression as AssignmentExpressionSyntax;
        assignmentExpr!.Left.ToString().Should().Be("_param2");
        assignmentExpr.Right.ToString().Should().Be("param2");
    }
...
public class TestClass
{
    ...
    public void TestMethod(string param1, int param2) 
    {
        ...
        // Assert
        var constructor = result.DescendantNodes().OfType<ConstructorDeclarationSyntax>().First();
        constructor.Body!.Statements.Should().HaveCount(3); // Original 2 + new assignment
        constructor.Body.Statements.Should().Contain(s => s.ToString().Contains("_param2 = param2"));
    }
...
public class TestClass
{
    ...
    public void TestMethod(string param1, int param2) 
    {
        ...
        // Assert
        var constructor = result.DescendantNodes().OfType<ConstructorDeclarationSyntax>().First();
        constructor.Body.Should().NotBeNull();
        constructor.Body!.Statements.Should().HaveCount(1);
        constructor.Body.Statements.First().ToString().Should().Contain("_param2 = param2");
    }
