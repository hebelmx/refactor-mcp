...
public class TestClass
{
    public void TestMethod() 
    {
        ...
        var cleanedCode = await File.ReadAllTextAsync(_testFilePath);
        cleanedCode.Should().Contain("using System;");
        cleanedCode.Should().Contain("using System.Collections.Generic;");
        cleanedCode.Should().Contain("using System.Linq;");
    }
...
public class TestClass
{
    public void TestMethod() 
    {
        ...
        result.Should().Contain("Removed unused usings");
        var cleanedCode = await File.ReadAllTextAsync(_testFilePath);
        cleanedCode.Should().Be(sourceCode); // No changes expected
    }
...
public class TestClass
{
    public void TestMethod() 
    {
        ...
        result.Should().Contain("Removed unused usings");
        var cleanedCode = await File.ReadAllTextAsync(_testFilePath);
        cleanedCode.Should().Contain("global using System;");
        cleanedCode.Should().Contain("global using System.Collections.Generic;");
        cleanedCode.Should().Contain("using System.Linq;");
    }
...
public class TestClass
{
    public void TestMethod() 
    {
        ...
        var cleanedCode = await File.ReadAllTextAsync(_testFilePath);
        cleanedCode.Should().Contain("using System;");
        cleanedCode.Should().Contain("using MyAlias = System.Collections.Generic.List<string>;");
        cleanedCode.Should().NotContain("using System.Collections.Generic;"); // Should be removed as it's not directly used
        cleanedCode.Should().NotContain("using System.Linq;"); // Should be removed as it's not used
    }
...
public class TestClass
{
    public void TestMethod() 
    {
        ...
        var cleanedCode = await File.ReadAllTextAsync(_testFilePath);
        cleanedCode.Should().Contain("using System;");
        cleanedCode.Should().Contain("using static System.Console;");
        cleanedCode.Should().Contain("using static System.Math;");
        cleanedCode.Should().NotContain("using System.Collections.Generic;"); // Should be removed
    }
